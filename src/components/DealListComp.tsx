...
export function DealListComp() {
    ...
    return (
        <>
            <a data-view-index="12" onClick={ addingItem } href="#addtocart" className="deal d-flex flex-column w-1o5" data-index="0">
            ...
            <a data-view-index="13" onClick={ addingItem } href="#addtocart" className="deal d-flex flex-column w-1o5" data-index="1">
            ...
            <a data-view-index="14" onClick={ addingItem } href="#addtocart" className="deal d-flex flex-column w-1o5" data-index="2">
            ...
            <a data-view-index="15" onClick={ addingItem } href="#addtocart" className="deal d-flex flex-column w-1o5" data-index="3">
            ...
            <a data-view-index="16" onClick={ addingItem } href="#addtocart" className="deal d-flex flex-column w-1o5" data-index="4">
